...
Los temas ya desarrollados son [Fundamentos de microservicios](fundamentos-de-microservicios.md), [Diseño de servicios](diseno-de-servicios.md), [DDD estratégico](ddd-estrategico.md), [DDD táctico y EventStorming](ddd-tactico-y-eventstorming.md), [Práctica de DDD](practica-ddd.md), [Contenedores sobre Linux](contenedores-linux.md), [Comunicación síncrona](comunicacion-sincrona.md), [Testing de microservicios](testing.md), [Sistemas distribuidos](sistemas-distribuidos.md), [Estado distribuido](estado-distribuido.md) y [DevOps y CI/CD](devops-y-ci-cd.md). La [entrega del Álbum 2026](entrega-album-2026.md) tiene su propia página de requisitos. El resto del recorrido funciona por ahora como índice del programa, no como contenido ya dictado o documentado en profundidad.
